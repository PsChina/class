...
exports.default = angular.module('bootstrapApp', ['ui.router', 'ngAnimate', 'ui.bootstrap', 'mainController', 'header', 'body']).config([function () {}]).run([function () {}]);

},{"./controller/mainController":3,"./directive/body":4,"./directive/header":5}],3:[function(require,module,exports){
'use strict';
