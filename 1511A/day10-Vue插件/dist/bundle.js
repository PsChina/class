...
/******/ 	var hotCurrentHash = "3cd9d1f894c4864a0eb9"; // eslint-disable-line no-unused-vars
...
var _vueGesture = __webpack_require__(13);
...
(0, _main2.default)(_vue2.default);
    ...
    install: function install(Vue, options) {
        ...
        Vue.directive('slipup', {
            bind: function bind(el, binding, vnode) {
                ...
                function end(event) {
                    ...
                    var distanceY = gestureManager.startPoint[1] - gestureManager.endPoint[1];
                    if (distanceY > 30) {
                        binding.value();
                    }
                }
        ...
        Vue.directive('slipleft', {
            bind: function bind(el, binding, vnode) {
                ...
                function end(event) {
                    var distanceX = gestureManager.startPoint[0] - gestureManager.endPoint[0];
                    if (distanceX > 30) {
                        binding.value();
                    }
                }
...
exports.default = function (Vue) {
    new Vue({
        ...
        created: function created() {
            ...
            //     throw error;
            // })
            this.$http.get('/getData').then(function (result) {
