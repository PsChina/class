...
angular.module('bootstrapApp', ['ui.bootstrap', 'ui.router', 'ngAnimate', 'mainController', 'header', 'body', 'bodyLeft', 'bodyRight'])
        .config(['$stateProvider', '$urlRouterProvider','$rootScope', function ($stateProvider, $urlRouterProvider,$rootScope) {
			$urlRouterProvider.otherwise('/startexam');
			$rootScope.currentRoute = '开始考试'
			$stateProvider.state('startExam', {
                        ...
                        resolve:{
							data:['$http',function($http){
								return $http({
									url:'http://localhost:3000/examlist'
