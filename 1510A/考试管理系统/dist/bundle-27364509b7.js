...
angular.module('bootstrapApp', ['ui.bootstrap', 'ui.router', 'ngAnimate', 'mainController', 'header', 'body', 'bodyLeft', 'bodyRight', 'constValue'])
	.config(['$stateProvider', '$urlRouterProvider', function ($stateProvider, $urlRouterProvider) {
		...
		$stateProvider.state('startExam', {
			...
			controller: ['$scope', 'getData', '$http', 'url','$timeout', function ($scope, getData, $http, url,$timeout) {
				...
				$scope.delete = function (examname) {
					...
					var tempArray = $scope.examlist;

					angular.forEach(tempArray, function (value, index, array) {
						console.log(value)
			...
			controller: ['$scope','getHistoryPaper', function ($scope,getHistoryPaper) {
