...
gulp.task('watch',function(){
    gulp.watch(['./index.html','./css/style.css'],['refreshBrowser'])
    gulp.watch(['./js/*/*.js','./js/*/*/*.js','./component/template/*.html'],['module','replaceSrc','refreshBrowser'])
})
